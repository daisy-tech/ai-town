    ...
    <div className="flex flex-col gap-6">
      ...
      >
        <div className="font-body">
          ...
          <p>
            欢迎来到奥特曼光之国！这里是奥特战士们生活和训练的地方。你可以作为<i>观察者</i>
            旁观，也可以点击「加入互动」与奥特战士们对话。
          </p>
          <h2 className="text-4xl mt-4">观察模式</h2>
          <p>
            点击并拖动可以在光之国中移动视角，滚动鼠标可以缩放。点击任意奥特战士（或右侧「人物」列表）可以查看他们的资料、记忆和对话历史。
          </p>
          ...
          <p className="mt-4">
            要与奥特战士对话，在「人物」面板中选中对方并点击「发起对话」。只要对方空闲并同意，就可以直接在面板中远程聊天，不需要走到对方身边。奥特战士也可能主动邀请你对话，你会在面板中看到接受按钮。
          </p>
          <p className="mt-4">
      ...
      <p className="text-base text-brown-100 leading-tight">
        提示：加入互动后，在「人物」面板选中奥特战士即可发起远程对话。
      </p>
    </div>
  );
}
